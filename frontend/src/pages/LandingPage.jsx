...
const Feature = ({ icon, title, children, delay }) => (
  <motion.div
    ...
    viewport={{ once: true }}
    className="bg-white p-6 rounded-lg shadow-md hover:shadow-green-500/50 hover:scale-105 transition-all duration-300"
  >
...
const Testimonial = ({ quote, author, delay }) => (
  ...
  >
    ...
    <p className="text-gray-800 font-bold mt-4">- {author}</p>
  </motion.div>
);
  ...
  return (
    <div className="bg-gray-50 text-gray-800 font-sans">
      ...
      <main className="container mx-auto px-6 pt-24 md:pt-32 text-center">
        ...
        >
          Inspect, transform, and deliver your webhooks with a developer-friendly platform.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">
              From local development to production-grade delivery, NeetoWebhooks has you covered.
            </p>
          </div>
      ...
      <section id="use-cases" className="py-20 bg-gray-100">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-lg">
              NeetoWebhooks is a versatile tool that can be used in a variety of scenarios.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <UseCase delay={0} title="Webhook Development">
              Develop and test webhooks locally without exposing your development server to the internet.
            </UseCase>
            <UseCase delay={0.1} title="Third-party Integrations">
              Integrate with third-party services that require a publicly accessible webhook URL.
            </UseCase>
            <UseCase delay={0.2} title="API Mocking">
              Create mock API endpoints to simulate webhook payloads for testing and development.
            </UseCase>
          </div>
        </div>
      </section>
