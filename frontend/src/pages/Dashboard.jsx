  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-4 mb-6">
        <StatCard title="Total Hooks" value={stats.total_hooks} />
        <StatCard title="Today" value={stats.hooks_today} />
        <StatCard title="Successful" value={stats.successful_hooks} />
        <StatCard title="Failed" value={stats.failed_hooks} />
      </div>
