...
class WebhookRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create webhook_request" do
    assert_difference("WebhookRequest.count") do
      post webhook_requests_url, params: { webhook_request: { body: @webhook_request.body, headers: @webhook_request.headers, ip_address: @webhook_request.ip_address, method: @webhook_request.method, status: @webhook_request.status } }, as: :json
    end
  ...
  test "should update webhook_request" do
    patch webhook_request_url(@webhook_request), params: { webhook_request: { body: @webhook_request.body, headers: @webhook_request.headers, ip_address: @webhook_request.ip_address, method: @webhook_request.method, status: @webhook_request.status } }, as: :json
    assert_response :success
  end
